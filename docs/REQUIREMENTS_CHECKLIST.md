...
| Checkout flow → confirmed booking (payment mocked) | ✅     | [`CheckoutPage.tsx`](../apps/web/src/pages/CheckoutPage.tsx) → [`BookingConfirmationPage.tsx`](../apps/web/src/pages/BookingConfirmationPage.tsx), `POST /bookings` | `bookings.test.ts`, manual (browser) |
